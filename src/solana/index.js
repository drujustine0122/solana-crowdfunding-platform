...
const programId = new PublicKey(
    "2zfD1Wy5Eu7b4nwPqPUoAkBB2R5Xd2YDFrHSQawt3oEW"
);
...
class CampaignDetails {
    ...
    static shema = new Map([[CampaignDetails,{
        kind: 'struct',
        fields: [
            ['admin', [32]],
            ['name', 'string'],
...
export async function createCampaign(
    ...
    let lamports = (await connection.getMinimumBalanceForRentExemption(data.length));
...
export async function donateToCampaign(
    ...
    const createProgramAccount = SystemProgram.createAccountWithSeed({
        ...
        basePubkey: wallet.publicKey,
        seed: SEED,
        newAccountPubkey: newAccount.encode,
        lamports: amount,
        space: 1,
        programId: programId,
    });
